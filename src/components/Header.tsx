      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-5">
            {site.links.github && (
              <a href={site.links.github} target="_blank" rel="noopener noreferrer" className={iconClass}>
            ...
            {site.links.linkedin && (
              <a href={site.links.linkedin} target="_blank" rel="noopener noreferrer" className={iconClass}>
                <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
            ...
            {site.links.twitter && (
              <a href={site.links.twitter} target="_blank" rel="noopener noreferrer" className={iconClass}>
                <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
            ...
            {site.links.email && (
              <a href={`mailto:${site.links.email}`} className={iconClass}>
